...
- 尝试比较迁移学习和自己编写的resnet18准确率，结果如下
  ...
  ![image-20220713205103216](../AppData/Roaming/Typora/typora-user-images/image-20220713205103216.png)

![image-20220713205214166](../AppData/Roaming/Typora/typora-user-images/image-20220713205214166.png)

代码实现：

![image-20220713205609942](../AppData/Roaming/Typora/typora-user-images/image-20220713205609942.png)

![image-20220713205629802](../AppData/Roaming/Typora/typora-user-images/image-20220713205629802.png)
...
第一次:![image-20220704161739485](C:\Users\xxn\AppData\Roaming\Typora\typora-user-images\image-20220704161739485.png)

第二次：![image-20220705000003245](C:\Users\xxn\AppData\Roaming\Typora\typora-user-images\image-20220705000003245.png)

后续实验准确率在0.9左右浮动，考虑应该是出现了过拟合的问题

# 7.9

- 成功生成csv文件，方便后续处理

  ![image-20220713174514331](C:\Users\xxn\AppData\Roaming\Typora\typora-user-images\image-20220713174514331.png)
...
- 对数据集进行7个类别的划分
  ...
  ![image-20220713172846498](C:\Users\xxn\AppData\Roaming\Typora\typora-user-images\image-20220713172846498.png)
